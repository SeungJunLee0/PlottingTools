...
#   for ring in rings:  
  ...
  pngName = "GEM_corr_dx_dy_" + plotsLabel + ".png"
  pdfName = "GEM_corr_dx_dy_" + plotsLabel + ".pdf"
  ...
  pngName = "GEM_corr_dx_dz_" + plotsLabel + ".png"
  pdfName = "GEM_corr_dx_dz_" + plotsLabel + ".pdf"
  c1.SaveAs(pngPath+pngName)
  c1.SaveAs(pdfPath+pdfName)
  ...
  pngName = "GEM_corr_dx_dphix_" + plotsLabel + ".png"
  pdfName = "GEM_corr_dx_dphix_" + plotsLabel + ".pdf"
  c1.SaveAs(pngPath+pngName)
  c1.SaveAs(pdfPath+pdfName)
  ...
  pngName = "GEM_corr_dx_dphiy_" + plotsLabel + ".png"
  pdfName = "GEM_corr_dx_dphiy_" + plotsLabel + ".pdf"
  c1.SaveAs(pngPath+pngName)
  c1.SaveAs(pdfPath+pdfName)
  ...
  pngName = "GEM_corr_dx_dphiz_" + plotsLabel + ".png"
  pdfName = "GEM_corr_dx_dphiz_" + plotsLabel + ".pdf"
  c1.SaveAs(pngPath+pngName)
  c1.SaveAs(pdfPath+pdfName)
  ...
  pngName = "GEM_corr_dy_dz_" + plotsLabel + ".png"
  pdfName = "GEM_corr_dy_dz_" + plotsLabel + ".pdf"
  c1.SaveAs(pngPath+pngName)
  c1.SaveAs(pdfPath+pdfName)
  ...
  pngName = "GEM_corr_dy_dphix_" + plotsLabel + ".png"
  pdfName = "GEM_corr_dy_dphix_" + plotsLabel + ".pdf"
  c1.SaveAs(pngPath+pngName)
  c1.SaveAs(pdfPath+pdfName)
  ...
  pngName = "GEM_corr_dy_dphiy_" + plotsLabel + ".png"
  pdfName = "GEM_corr_dy_dphiy_" + plotsLabel + ".pdf"
  c1.SaveAs(pngPath+pngName)
  c1.SaveAs(pdfPath+pdfName)
  ...
  pngName = "GEM_corr_dy_dphiz_" + plotsLabel + ".png"
  pdfName = "GEM_corr_dy_dphiz_" + plotsLabel + ".pdf"
  c1.SaveAs(pngPath+pngName)
  c1.SaveAs(pdfPath+pdfName)
  ...
  pngName = "GEM_corr_dz_dphix_" + plotsLabel + ".png"
  pdfName = "GEM_corr_dz_dphix_" + plotsLabel + ".pdf"
  c1.SaveAs(pngPath+pngName)
  c1.SaveAs(pdfPath+pdfName)
  ...
  pngName = "GEM_corr_dz_dphiy_" + plotsLabel + ".png"
  pdfName = "GEM_corr_dz_dphiy_" + plotsLabel + ".pdf"
  c1.SaveAs(pngPath+pngName)
  c1.SaveAs(pdfPath+pdfName)
  ...
  pngName = "GEM_corr_dz_dphiz_" + plotsLabel + ".png"
  pdfName = "GEM_corr_dz_dphiz_" + plotsLabel + ".pdf"
  c1.SaveAs(pngPath+pngName)
  c1.SaveAs(pdfPath+pdfName)
  ...
  pngName = "GEM_corr_dphix_dphiy_" + plotsLabel + ".png"
  pdfName = "GEM_corr_dphix_dphiy_" + plotsLabel + ".pdf"
  c1.SaveAs(pngPath+pngName)
  c1.SaveAs(pdfPath+pdfName)
  ...
  pngName = "GEM_corr_dphix_dphiz_" + plotsLabel + ".png"
  pdfName = "GEM_corr_dphix_dphiz_" + plotsLabel + ".pdf"
  c1.SaveAs(pngPath+pngName)
  c1.SaveAs(pdfPath+pdfName)
  ...
  pngName = "GEM_corr_dphiy_dphiz_" + plotsLabel + ".png"
  pdfName = "GEM_corr_dphiy_dphiz_" + plotsLabel + ".pdf"
  c1.SaveAs(pngPath+pngName)
  c1.SaveAs(pdfPath+pdfName)
